...
// `OutputFormat` lives in `SwiftStaticAnalysisCore`.
// `OutputFormatter` + `CombinedReport` now live in `SwiftStaticAnalysisOutput`
// so MCP/LSP/library consumers route through the same renderer instead of
// duplicating it.
